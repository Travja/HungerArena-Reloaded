...
public class HelpModule extends CommandModule {
    ...
    public HelpModule(CommandModule parent, String name, String permission, String permissionMessage, String usage, String... alias) {
    ...
    private ArrayList<String> list = new ArrayList<>(Arrays.asList(
            ...
            c + "/sponsor <Player> <ItemID> <Amount> - Lets you sponsor someone!" //TODO Revamp sponsorships
    ));
